...
class TestNoauxTC:
    ...
    @pytest.mark.parametrize(
        ('num_experts', 'n_group', 'topk_group', 'routed_scaling_factor'),
        [
            pytest.param(256, 8, 4, 2.5, id='deepseek'),
            pytest.param(384, 1, 1, 2.827, id='kimi-k2.6'),
            pytest.param(384, 8, 4, 2.827, id='padded-groups'),
        ],
    )
    @pytest.mark.parametrize('renormalize', [False, True])
    def test_noaux_tc_router(
        self,
        batch_size,
        num_experts,
        n_group,
